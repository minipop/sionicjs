...
function Sionic(mmldata) {
    ...
    var MMLTrack = (function() {
        ...
        MMLTrack.prototype.doCommand = function(cmd) {
            ...
            switch (cmd.name) {
                case "#FM2OP@":
                    this.fmParams128[cmd.val[0]] = cmd.val;
                    break;
                case "@":
                    if (this.fmParams128[cmd.val]) {
                      this.toneGenerator = new FM2OP(this.fmParams128[cmd.val]);
                    } else {
                      switch (cmd.val) {
                          case 3:
                              this.toneGenerator = new PwmGenerator();
